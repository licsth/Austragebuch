...
<head>
    ...
    <title>Postdienst hinzufügen</title>
    ...
    <div class="container theme-showcase" role="main">
        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-md-8 col-sm-10 center-block">
                <h2>Postdienst hinzufügen</h2>
                <p>
                  Hier kannst du Schülern Postdienstrechte einräumen. Gib dazu einfach den Nutzernamen oder den vollständigen Namen des Schülers an.
                </p>
                <?php
                        //Fehlermeldungen
                    if($src == 'name'){
                ...
                <form class="form" action="processing/postdienst.php" method="post">
