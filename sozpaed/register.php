    ...
    <div class="container theme-showcase" role="main">
        ...
        <a href="sozpaed.php"><span class="glyphicon glyphicon-home" style="font-size: 2em;" aria-hidden="true"></span></a><br>
            ...
            echo "<div class='alert alert-danger' role='alert'>Falsches Dateiformat. Bitte eine Datei mit der Endung <code>.csv</code> hochladen.</div>";
                ...
                <p id="description">Mit diesem Tool kannst du Nutzer über einen CSV-Import registrieren. CSV-Dateien sind Dateien, die Excel-Tabellen als Text wiedergeben. Nutze den Import, indem du eine .csv-Datei hochlädst, die zu registrierende Nutzer nach dem Schema "Vorname; Nachname(; WG)" (WG nur bei Schülern) enthält. <br>Du kannst eine solche Datei in Excel mit der Funktion <code>Datei > Speichern unter</code> mit dem Dateiformat .csv erstellen.</p>
                ...
                <form enctype="multipart/form-data" method="post" action="processing/register.php">
                    <div class="form-group">
                        <select name="role">
                            ...
                            <option value="sozpaed">SozPäds</option>
                        </select>
                    </div>
                    <div class="form-group">
